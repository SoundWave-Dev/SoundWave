...
ASGI_APPLICATION = "soundwave.asgi.application"

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.getenv("DB_NAME", "soundwave"),
        "USER": os.getenv("DB_USER", "soundwave"),
        "PASSWORD": os.getenv("DB_PASSWORD", "soundwave"),
...
# Payment gateway config — see apps/billing/gateways.py
PAYMENT_GATEWAY = os.getenv("PAYMENT_GATEWAY", "zarinpal")
PAYMENT_GATEWAY_MERCHANT_ID = os.getenv("PAYMENT_GATEWAY_MERCHANT_ID", "")
PAYMENT_GATEWAY_SANDBOX = os.getenv("PAYMENT_GATEWAY_SANDBOX", "True") == "True"
